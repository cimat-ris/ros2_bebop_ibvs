...
setup(
    ...
    data_files=[
        ...
        (os.path.join('share', package_name, 'models','parrot_bebop_2_custom'), glob('models/parrot_bebop_2_custom/model.sdf')),
        (os.path.join('share', package_name, 'models','parrot_bebop_2_custom'), glob('models/parrot_bebop_2_custom/model.config')),
        (os.path.join('share', package_name, 'models','parrot_bebop_2_custom','meshes'), glob('models/parrot_bebop_2_custom/meshes/*')),
