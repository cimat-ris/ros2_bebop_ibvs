...
def generate_launch_description():
    ...
    pkg_bebop_hbvs = get_package_share_directory('ros2_bebop_ibvs')
    ...
    ros_gz_bridge = RosGzBridge(
        ...
        config_file=os.path.join(pkg_bebop_hbvs, 'config', 'bebop1.yaml'),
    )



    #   Spawn bebop
    bebop_model = os.path.join(pkg_bebop_hbvs,"models","parrot_bebop_2","model.sdf")
    ...
    # config["ref_image"] = os.path.join(pkg_bebop_hbvs, 'config', 'reference_4_2.png')
    config["ref_image"] = os.path.join(pkg_bebop_hbvs, 'config', 'reference_2_flat.png')
    # config["ref_image"] = os.path.join(pkg_bebop_hbvs, 'config', 'reference_1_aruco.png')
